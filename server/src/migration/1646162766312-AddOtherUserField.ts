...
export class AddOtherUserField1646162766312 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`bbbjytrwewte\` varchar(255) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`aaajytrwewte\` \`aaajytrwewte\` varchar(255) NULL`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`aaajytrwewte\` \`aaajytrwewte\` varchar(255) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`bbbjytrwewte\``);
    }
